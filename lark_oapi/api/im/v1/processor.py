...
class P2ImChatDisbandedV1Processor(IEventProcessor[P2ImChatDisbandedV1]):
    ...
    async def do(self, data: P2ImChatDisbandedV1) -> None:
        await self.f(data)
...
class P2ImChatUpdatedV1Processor(IEventProcessor[P2ImChatUpdatedV1]):
    ...
    async def do(self, data: P2ImChatUpdatedV1) -> None:
        await self.f(data)
...
class P2ImChatAccessEventBotP2pChatEnteredV1Processor(
    ...
    async def do(self, data: P2ImChatAccessEventBotP2pChatEnteredV1) -> None:
        await self.f(data)
...
class P2ImChatMemberBotAddedV1Processor(IEventProcessor[P2ImChatMemberBotAddedV1]):
    ...
    async def do(self, data: P2ImChatMemberBotAddedV1) -> None:
        await self.f(data)
...
class P2ImChatMemberBotDeletedV1Processor(IEventProcessor[P2ImChatMemberBotDeletedV1]):
    ...
    async def do(self, data: P2ImChatMemberBotDeletedV1) -> None:
        await self.f(data)
...
class P2ImChatMemberUserAddedV1Processor(IEventProcessor[P2ImChatMemberUserAddedV1]):
    ...
    async def do(self, data: P2ImChatMemberUserAddedV1) -> None:
        await self.f(data)
...
class P2ImChatMemberUserDeletedV1Processor(
    ...
    async def do(self, data: P2ImChatMemberUserDeletedV1) -> None:
        await self.f(data)
...
class P2ImChatMemberUserWithdrawnV1Processor(
    ...
    async def do(self, data: P2ImChatMemberUserWithdrawnV1) -> None:
        await self.f(data)
...
class P2ImMessageMessageReadV1Processor(IEventProcessor[P2ImMessageMessageReadV1]):
    ...
    async def do(self, data: P2ImMessageMessageReadV1) -> None:
        await self.f(data)
...
class P2ImMessageRecalledV1Processor(IEventProcessor[P2ImMessageRecalledV1]):
    ...
    async def do(self, data: P2ImMessageRecalledV1) -> None:
        await self.f(data)
...
class P2ImMessageReceiveV1Processor(IEventProcessor[P2ImMessageReceiveV1]):
    ...
    async def do(self, data: P2ImMessageReceiveV1) -> None:
        await self.f(data)
...
class P2ImMessageReactionCreatedV1Processor(
    ...
    async def do(self, data: P2ImMessageReactionCreatedV1) -> None:
        await self.f(data)
...
class P2ImMessageReactionDeletedV1Processor(
    ...
    async def do(self, data: P2ImMessageReactionDeletedV1) -> None:
        await self.f(data)
